...
Content.create(title: 'Your Name', 
               ...
               type:'movie', 
                ...
                review: "If you watched this without subtitles, you'd still be crying by the end. This overtook Spirited Away in sales, GOAT.", 
                rating: 98, 
...
Content.create(title: 'Durarara!!', 
               ...
               review:'The animation and character development is mind-blowing, I never wanted the series to end!', 
               rating: 79, 
               platform:'Hulu', 
               user_id: 2, 
               queue_list_id: 2)
Content.create(title: 'The Mandalorian', 
                ...
                review:"Baby Yoda single-handedly saved the entire Star Wars franchise and Disney from losing money during COVID-19. Let's be real, he's the only reason why I even have a subscription.", 
                rating: 93, 
                platform:'Disney+', 
                user_id: 1, 
                queue_list_id: 3)
...
Content.create(title: 'The Sopranos', 
                ...
                review:'One of the most iconic TV shows of all time. If you love TV you will love The Sopranos. Getting into the mind of the most feared mob bosses on televison will have you bingeing the whole thing before you know it.', 
                rating: 92, 
                platform:'HBO Max', 
                user_id: 2, 
                queue_list_id: 1)
...
Content.create(title: 'The Boys', 
                ...
                review: "Imagine if the Avengers were messed up by the darkest parts of coroporate America, and there's so much gore that Game of Thrones feels rated G in comparison. You can't help but root for the boys as they take on the herculean task of taking down these asshole Supes.", 
                rating: 90, 
...
Content.create(title: 'The Expanse', 
                ...
                review:'It was dropped from Sci-fi after season 3, but this show is so good that Daddy Bezos picked it up himself to satisfy his needs.', 
                rating: 89, 
                platform:'Prime Video', 
                user_id: 2, 
                queue_list_id: 1)
...
Content.create(title: 'Spider-Man: Into the Spider-Verse', 
                ...
                review:"Great multi-verse movie with insane, vibrant, trippy visuals. The art team is on some next level stuff, Michelangelo could never!", 
                rating: 97, 
                platform:'Prime Video', 
                user_id: 1, 
                queue_list_id: 2)
Content.create(title: 'Parasite', 
                ...
                review:"Honestly it was pretty funny until a certain point. Then my mind was blown until the end and I can't even describe what I witnessed. You have to watch it to know what I'm talking about. There's a reason why Bong Joon-ho won best foreign and best film that year.", 
                rating: 98, 
                platform:'Hulu', 
                user_id: 2, 
                queue_list_id: 3)
...
Content.create(title: 'Home Alone', 
                ...
                review:'What I leanred from this movie is that we need more people like Kevin in the world. Now, everyday when I wake up I tell myself be a Kevin.', 
                rating: 69, 
                platform:'Disney+', 
                user_id: 2, 
                queue_list_id: 3)
...
Content.create(title: 'Coco', 
                ...
                review:"I got escorted out of theatre for crying too much and using the usher's jacket as tissues. I still begin crying uncontrollably to this day when I see commercials for that chocolate puff cereal.", 
                rating: 97, 
                platform:'Disney+', 
                user_id: 1, 
                queue_list_id: 3)
Content.create(title: 'Love Actually', 
                ...
                review: "Grab a tissue becasue you're about to bawl your eyes out. This movie not only warms your heart, but will make you fall in love with each and every character. This eclectic cast with multiple entertwining story lines is one of the best RomComs out there.", 
                rating: 64, 
                platform:'Prime Video', 
                user_id: 2, 
                queue_list_id: 4)
Content.create(title: 'The Princess Bride', 
                ...
                review:"It's inconceivable how they made such a good movie for all age groups. My 4th son from my 7th failed marriage always bugs me to watch it with him and how else can I repsond but with 'As you wish?'", 
                rating: 87, 
                platform:'Disney+', 
                user_id: 1, 
                queue_list_id: 3)
...
Content.create(title: 'The Hangover', 
                ...
                review:"This movie embodies all the dumb shit I did back in the day. I'm amazed I'm still alive after thinking about it. Lmaooo", 
                rating: 78, 
                platform:'Prime Video', 
                user_id: 2, 
                queue_list_id: 5)
...
Content.create(title: 'Deadpool', 
                ...
                review:"Stupid sexy Ryan Reynolds, that's all I gotta say. I'm a loyal guy, but he really be pushing me to my limits. Lowkey I also learned that if I develop cancer in life, keep up the good fight and you might have a chance after going to hell and back. 10/10", 
                rating: 85, 
                platform:'Hulu', 
                user_id: 1, 
                queue_list_id: 5)
...
Content.create(title: 'Breaking Bad', 
                ...
                review:"Meth truly changes lives. Teachers are underpaid. These are the two absolutes in life, and if I want to add a third, it would be that Breaking Bad's lowest rating for an episode ever was a 7.8. This show is the reason why I'm in rehab now.", 
                rating: 96, 
                platform:'Netflix', 
                user_id: 2, 
                ueue_list_id: 1)
...
Content.create(title: 'Brooklyn Nine-Nine', 
               ...
               review: 'Wildly kooky and straight-up hilarious. This shows keeps you laughing while also tackling some real life situations. This show never gets old and is one of the best comedies out there.', 
               rating: 95, 
               platform: 'Hulu', 
               user_id: 1, 
               queue_list_id: 5)
...
Content.create(title: 'Halt and Catch Fire', 
               ...
               review: "This is a great glimpse intothe  dawn of the age of the computer. The characters are great and show evolves well. Get ready for some 80's nostalgia, a little bit of computer history and a lot of fun scenes.", 
               rating: 90, 
               platform: 'Netflix', 
               user_id: 1, 
               queue_list_id: 1)
...
Content.create(title: 'Cowboy Bebop', 
               ...
               review: "One ofthe most iconic anime's of all time! If you like bounty hunters, wild adventures, jazz music and space... this is the right show for you. Even if you don't like any of those things... still watch this show. You won't regret it.", 
               rating: 100, 
               platform:'Crunchyroll', 
               user_id: 2, 
               queue_list_id: 2)
...
Content.create(title: 'Avatar: The Last Airbender', 
               ...
               review:"I could never get into American animated media as a child, but then I watched this GOAT show. Every single character from supporting to main is so well thought out and developed. The plot never dips for a second and you feel like part of team avatar, undergoing an epic journey. Zuko's character arc alone makes Jaime's from GOT look like a deformed circle. Uncle Iroh made me question my own sexuality, because smart is soooo sexy. I could go on, but I'll let the show do the talking.", 
               rating: 100, 
               platform: 'Netflix', 
               user_id: 1, 
               queue_list_id: 2)
...
Content.create(title: 'The Godfather', 
               ...
               review: 'One of the best movies of all time. The character arcs are amazing and the scenes are iconic. Direction and acting are superb.', 
               rating: 98, 
               platform: 'Prime Video', 
               user_id: 2, 
               queue_list_id: 1)
...
Content.create(title: "Schitt's Creek", 
               ...
               review: 'One of the funniest comedy sitcoms to ever exist! Once the humor sets in you will be binging and laughing for days to come. It has a bunch of Emmys for a reason.', 
               rating: 93, 
               platform: 'Neflix', 
               user_id: 2, 
               queue_list_id: 5)
...
Content.create(title: 'Crazy Rich Asians', 
               ...
               review:"Even though this is in my date night queue, would not recommend watching with SO. After we did, she developed unrealistic expectations of my wealth and ultimately left me for some rich asian guy. GG", 
               rating: 91, 
               platform: 'HBO Max', 
               user_id: 1, 
               queue_list_id: 4)
...
Content.create(title: 'The Royal Tenenbaums', 
               ...
               review: 'Quirky and fun. Get ready to  immerse yourself in the world of this disfunctional family with unique characters. Wes Anderson has an impecable music selection and masterfully crafts his shots.', 
               rating: 80, 
               platform: 'Prime Video', 
               user_id: 2, 
               queue_list_id: 1)
...
Content.create(title: 'Demon Slayer: Kimetsu no Yaiba', 
               ...
               review:"I'm a big fan of the show. Nezuko is just so fun and her voice lines so cute LOL! She's super random but also smarter than she looks, just like me xD. The animation quality is also top notch, but I am scared of the fight scenes so I can only watch with my mom hehe", 
               rating: 100, 
               platform: 'Hulu', 
               user_id: 1, 
               queue_list_id: 2)
...
Content.create(title: 'Rick and Morty',
               ...
               review: "I started watching this show sober, but the stuff that happens is so wild that I questioned my own existence, sobriety, and reality itself just 22 short minutes later. How Can Mirrors Be Real If Our Eyes Aren't Real - Jaden Smith.", 
               rating: 94, 
               platform: 'Hulu', 
               user_id: 1, 
               queue_list_id: 2)
...
Content.create(title: 'Casablanca', 
               ...
               review: "One of the greatest films of all time. The classic of all classics, anyone who loves films must give this a watch and then immediately start quoting the last scene to other film buffs", 
               rating: 99, 
               platform: 'HBO Max', 
               user_id: 2,
               queue_list_id: 1)
...
Content.create(title: 'Titanic', 
               ...
               review: "A perfect film to watch on movie night. Be sure to get your tissue box ready and to fall in love with Leo all over again. Also, Rose totally had enough room for him on the wooden plank smh. I'm the king of the world!!!!", 
               rating: 89, 
               platform: 'Hulu', 
               user_id: 1, 
               queue_list_id: 4)
...
Content.create(title: 'Silicon Valley', 
               ...
               review:'Wildly hilarious and great portrayal of what Silicon Valley is like for those trying to make. Release your inner nerd and do not miss this amazing show', 
               rating: 94, 
               platform: 'HBO Max', 
               user_id: 2, 
               queue_list_id: 5)
...
Content.create(title: 'Adventure Time', 
               ...
               review:'The animation is beautiful and the world is incredibly unique. Your imagination will run wild with every epsiode.', 
               rating: 100, 
               platform:'HBO Max', 
               user_id: 2, 
               queue_list_id: 2)
...
Content.create(title: 'Blue Planet II', 
               ...
               review:"This really makes you appreciate how beautiful mother earth's gifts are. I can't believe how we're polluting our planet in this way. I'm hopping on the first ship to Mars, can't take it anymore knowing these places may not be around much longer.", 
               rating: 97, 
               platform:'Netflix', 
               user_id: 1, 
               queue_list_id: 3)
...
Content.create(title: 'Atlanta', 
               ...
               review:"One of the best new TV shows out there. I was so impressed with the detail in every shot and the writing. This is a must watch!", 
               rating: 97, 
               platform:'Hulu', 
               user_id: 2, 
               queue_list_id: 1)
...
Content.create(title: "Chef's Table", 
               ...
               review:'Watching this show made me go bankrupt. I used all of my money on these featured restaurants and I regret nothing as I type this review from the public library computers.', 
               rating: 96, 
               platform: 'Netflix', 
               user_id: 1, 
               queue_list_id: 1)
...
Content.create(title: 'Westworld', 
               ...
               review:'Love this show, had me on the edge of my seat!', 
               rating: 82, 
               platform:'HBO Max', 
               user_id: 2, 
               queue_list_id: 1)
